...
import { ArrowLeft02Icon, MinusSignIcon, PlusSignIcon, ShoppingCart01Icon } from '@hugeicons/core-free-icons'
        ...
        {cart.length < 1 ? (
          <div className='w-full h-screen flex items-center justify-center'>
            <div className='bg-zinc-200 rounded-md p-16 w-fit h-fit text-center flex flex-col items-center justify-center'>
              <HugeiconsIcon icon={ShoppingCart01Icon} className="animate-bounce text-green-500" size={56} />
              <h2 className='text-zinc-800 font-semibold'>Empty Cart</h2>
              <p className='text-zinc-800 text-sm my-2'>You have not added any items to your cart</p>
            </div>
          </div>
        ) : (
          <div>
